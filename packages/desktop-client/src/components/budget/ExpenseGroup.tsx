...
type ExpenseGroupProps = {
  ...
  onShowNewSubgroup?: ComponentProps<typeof SidebarGroup>['onShowNewSubgroup'];
  onIndent?: ComponentProps<typeof SidebarGroup>['onIndent'];
  onOutdent?: ComponentProps<typeof SidebarGroup>['onOutdent'];
};
